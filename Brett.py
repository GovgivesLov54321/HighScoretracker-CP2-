...
#welcom()
    ...
    #enter a number 1 to check if you have an account 2 to login 3 to create an account
    #if user entered 1
        #call enter()
    #if user entered 2
        #call
...
#create()
    #while true
        ...
        #save as ("username": user_username, "password": user_password, "user_id": __) in Json file
        #Call enter
